...
public class ValidMovesTests {
    ...
    public void moveIntoCheck() {
        ...
        var validMoves = loadMoves(rookPosition, new int[][]{{5, 7}, {5, 5}, {5, 4}, {5, 3}, {5,
                2}});
    ...
    public void rookPinnedToKing() {
        ...
        Assertions.assertTrue(game.validMoves(position).isEmpty(), "ChessGame validMoves returned" +
                " valid moves for a trapped piece");
    }
    ...
    public void kingInDanger() {
        ...
        Assertions.assertTrue(game.validMoves(pawnPosition).isEmpty(), "ChessGame validMoves " +
                "returned valid moves for a trapped piece");
        Assertions.assertTrue(game.validMoves(bishopPosition).isEmpty(), "ChessGame validMoves " +
                "returned valid moves for a trapped piece");
        Assertions.assertTrue(game.validMoves(queenPosition).isEmpty(), "ChessGame validMoves " +
                "returned valid moves for a trapped piece");
        Assertions.assertTrue(game.validMoves(knightPosition).isEmpty(), "ChessGame validMoves " +
                "returned valid moves for a trapped piece");
        Assertions.assertTrue(game.validMoves(rookPosition).isEmpty(), "ChessGame validMoves " +
                "returned valid moves for a trapped piece");
    }
